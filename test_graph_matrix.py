...
if __name__ == "__main__":
    ...
    for name in ["cora.mtx", "pubmed.mtx", "lpi_forest6.mtx", "citeseer.mtx", \
                 "nell.mtx", "Computers.mtx", "ca-CondMat.mtx", "Hardesty2.mtx", \
                 "cari.mtx", "email-Enron.mtx", "poisson3Da.mtx", "web-Google.mtx"]:
        simulation_top(os.path.join(base_dir, name), "result_graph_spmm.txt")
